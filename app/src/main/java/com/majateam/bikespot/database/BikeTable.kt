...
object BikeTable {
    ...
    @JvmStatic fun onCreate(database: SQLiteDatabase) {
    ...
    @JvmStatic fun onUpgrade(database: SQLiteDatabase, oldVersion: Int,
                             newVersion: Int) {
    ...
    @JvmStatic fun onInsertList(database: SQLiteDatabase, bikes: List<Bike>): Boolean {
